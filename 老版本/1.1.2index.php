...
<body>
                        ...
                        <td class="preview">
                            <?php if ($item['type'] === 'file'): ?>
                                ...
                                if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif'])) {
                                    ...
                                    echo "<div class='media-placeholder' onclick=\"toggleMedia('$fileUrl', 'video', this)\">";
                                    echo "点击播放视频 <i class='material-icons'>play_arrow</i>";
                                    echo "</div>";
                                    echo "<div class='media-player' style='display:none;' data-url='$fileUrl' data-type='video'>";
                                    ...
                                    echo "<div class='media-placeholder' onclick=\"toggleMedia('$fileUrl', 'audio', this)\">";
                                    echo "点击播放音频 <i class='material-icons'>play_arrow</i>";
                                    echo "</div>";
                                    echo "<div class='media-player' style='display:none;' data-url='$fileUrl' data-type='audio'>";
                                    echo "<audio controls>";
    ...
    <script>
        ...
        // 媒体播放切换功能
        function toggleMedia(url, type, placeholder) {
            // 隐藏所有其他媒体播放器
            ...
            // 查找对应的媒体播放器
            const player = placeholder.nextElementSibling;
